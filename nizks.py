<?php
//=========التوكن=========//
$token = "6211985413:AAGcjAUDodBnEr2RX0oun8OEEFdkJTk2yw8"
fine("API_KEY", $token);
...
#############
$admin = "1169809290";
$Dev = array("$admin","1169809290");
$eri = array("$admin","1169809290");
$idbot = "6083414712";
$sudo = "$admin";
$buy = "UnitedLibertypaper";
$DevUser = "@$buy";
$devchink = "UnitedLibertypaper";
$userbot = "ChatGPTULPBot";
$chsource = "$devchink";
############
if ($tc == 'private'){  
@$user = json_decode(file_get_contents("data/user.json"),true);
...
⋄︙ [تحديثات السورس الجديده](https://t.me/$userbot = "ChatGPTULPBot";
)",
'parse_mode'=>"markdown",
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/$userbot = "ChatGPTULPBot";
"]],
]])
]); 
}
...
⌯⁞ لعرض الايدي ~⪼ `{Id}`
⌯⁞ قناة تعين : [@$userbot = "ChatGPTULPBot";
]
",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
 ...
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"",'url'=>"t.me/$userbot = "ChatGPTULPBot";
"]],
]])
]);
}}}
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/$userbot = "ChatGPTULPBot";
"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
